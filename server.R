...
pos <- scan('D:/R/cpsc531/mobilecomparison/wordList/positive.txt', what='character', comment.char=';') #folder with positive dictionary
neg <- scan('D:/R/cpsc531/mobilecomparison/wordList/negative.txt', what='character', comment.char=';') #folder with negative dictionary
